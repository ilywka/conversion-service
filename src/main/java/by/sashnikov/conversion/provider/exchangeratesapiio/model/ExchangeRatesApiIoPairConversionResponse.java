...
import by.sashnikov.conversion.provider.exchangeratesapiio.model.ExchangeRatesApiIoPairConversionResponse.PairConversionResponseDeserializer;
import lombok.Data;
...
public abstract class ExchangeRatesApiIoPairConversionResponse {


     static class PairConversionResponseDeserializer extends StdDeserializer<ExchangeRatesApiIoPairConversionResponse> {
        ...
        @Override
        public ExchangeRatesApiIoPairConversionResponse deserialize(JsonParser p, DeserializationContext ctxt) throws
            IOException {
